export default async function sitemap() {
  ...
  const routes = [
    ...
    "/locais-de-atendimento/sarandi",
    "/locais-de-atendimento/paicandu",
    "/locais-de-atendimento/mandaguacu",
    "/locais-de-atendimento/marialva",
    "/locais-de-atendimento/iguaracu",
    "/locais-de-atendimento/regiao-metropolitana-de-maringa",
    "/locais-de-atendimento/tamboara",
    "/locais-de-atendimento/terra-rica",
    "/locais-de-atendimento/loanda",
    "/locais-de-atendimento/guairaca",
    "/locais-de-atendimento/noroeste-do-parana",
